...
export class EffectMeasuredTemplate extends MeasuredTemplate {
  static fromItem(item) {
    this.flags = item.data.flags.effecttemplate
    const templateShape = config.SHAPES[this.flags.shape]
    if (!templateShape) return null

    // Prepare template data
    const templateData = {
      t: templateShape.measuredTemplate,
      user: game.user._id,
      distance: this.flags.distance,
      direction: 0,
      x: 0,
      y: 0,
      fillColor: null,
